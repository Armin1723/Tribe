...
async function page ({params, searchParams}){
    ...
    return(
        <div className="custom-scrollbar flex flex-col justify-center mb-[8vh] max-lg:min-w-[85vw] items-center w-full md:w-[65vw] text-white font-inter max-sm:px-4 px-2">
